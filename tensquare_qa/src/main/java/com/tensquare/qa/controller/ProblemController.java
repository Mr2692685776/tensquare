...
//
    ...
    public Result newList(@PathVariable("label") String labelId, @PathVariable("page") int page,
                          @PathVariable("size") int size) {
		Page<Problem> problems = problemService.newList(labelId, page, size);
		return new Result(StatusCode.OK,true,"操作成功",new PageResult<>(problems.getTotalElements(),
				problems.getContent()));
	}
//
    /**
    ...
    public Result hotList(@PathVariable("label") String labelId, @PathVariable("page") int page,
                          @PathVariable("size") int size) {
...
//
    ...
    public Result waitList(@PathVariable("label") String labelId, @PathVariable("page") int page,
                          @PathVariable("size") int size) {
